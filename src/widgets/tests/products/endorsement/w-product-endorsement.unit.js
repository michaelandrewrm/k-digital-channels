...
import Component from '@widgets/products/endorsement/w-product-endorsement.vue';
import endorsements from '@tests/fixtures/products/endorsements';

const newInstance = createPristineVue();
const { localVue } = newInstance;

describe('w-product-endorsement.vue', () => {
	let wp;
	...
	it('has a name equal to w-product-endorsement', () => {
		expect(wp.vm.$options.name).toBe('w-product-endorsement');
	});
