<template>
	<div class="w-detail-fund">
		<div class="w-detail-fund__group">
...
.w-detail-fund__group:empty {
	display: none;
}

.w-detail-fund__group > *:not(:last-child) {
	margin-bottom: 15px;
}

.w-detail-fund__group:last-of-type:not(:first-of-type) {
	border-bottom: 1px solid RGBA(var(--color-primary-surface), 0.2);
}

.w-detail-fund__profiles-list {
	padding-right: 30px;
	overflow: hidden;
}

.w-detail-fund__profiles-list li:not(:last-child):after {
	content: ',';
	margin-right: 5px;
}

.w-detail-fund__profiles-list li {
