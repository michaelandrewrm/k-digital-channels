<template>
	<c-acrylic-sheet :dotted="true">
		...
		<span class="w-movement-sheet-pension-plan__reason text-fixed-m-medium" v-if="movement.reason">
			{{ movement.reason }}
		</span>
...
export default {
	name: 'w-movement-sheet-pension-plan',
...
.w-movement-sheet-pension-plan__reason {
	margin-bottom: 10px;
}
</style>
