<template>
	<div class="w-detail-managed-rsi-portfolio">
		<div class="w-detail-managed-rsi-portfolio__group">
			<c-list-icon-item
		...
		<div
			v-if="detail"
			class="w-detail-managed-rsi-portfolio__group"
		...
		>
			<c-list-icon-item
				class="w-detail-managed-rsi-portfolio__profiles"
				:title="this.$t('DETAIL.PROFILES.PROFILE')"
				:description="profilesDescription"
				icon="@icons/interveners"
				actionable
			>
				<ul class="w-detail-managed-rsi-portfolio__profiles-list">
...
export default {
	name: 'w-detail-managed-rsi-portfolio',
...
.w-detail-managed-rsi-portfolio__group {
	display: block;
...
.w-detail-managed-rsi-portfolio__group:empty {
	display: none;
}

.w-detail-managed-rsi-portfolio__group > *:not(:last-child) {
	margin-bottom: 15px;
}

.w-detail-managed-rsi-portfolio__product-profitability {
	padding-bottom: 8px;
}

.w-detail-managed-rsi-portfolio__group:last-of-type:not(:first-of-type) {
	border-bottom: 1px solid RGBA(var(--color-primary-surface), 0.2);
}

.w-detail-managed-rsi-portfolio__profiles-list {
	padding-right: 30px;
	overflow: hidden;
}

.w-detail-managed-rsi-portfolio__profiles-list li:not(:last-child):after {
	content: ',';
	margin-right: 5px;
}

.w-detail-managed-rsi-portfolio__profiles-list li {
