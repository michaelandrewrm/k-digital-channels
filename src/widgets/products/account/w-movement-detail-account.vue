<template>
	<section class="w-movement-detail-account">
		<c-list-icon-item
			class="w-movement-detail-account__item"
			v-if="movement.id"
			:title="$t('MOVEMENT.ID')"
		...
		<c-list-icon-item
			class="w-movement-detail-account__item media-screen-hide"
...
export default {
	name: 'w-movement-detail-account',
...
.w-movement-detail-account__item:not(:last-child) {
	margin-bottom: 18px;
}
</style>
