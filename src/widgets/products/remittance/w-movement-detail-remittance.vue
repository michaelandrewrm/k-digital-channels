<template>
	<section class="w-movement-detail-remittance">
		<c-list-icon-item
			class="w-movement-detail-remittance__item"
			v-if="movement.id"
			:title="$t('MOVEMENT.ID')"
		...
		<c-list-icon-item
			class="w-movement-detail-remittance__item media-screen-hide"
...
export default {
	name: 'w-movement-detail-remittance',
...
.w-movement-detail-remittance__item:not(:last-child) {
	margin-bottom: 18px;
}
</style>
