...
import Component from '@modals/m-available-balance.vue';
...
describe('m-available-balance.vue', () => {
	let wp;
	let store;
	...
	it('has a name equal to m-available-balance', () => {
		expect(wp.vm.$options.name).toBe('m-available-balance');
	});
