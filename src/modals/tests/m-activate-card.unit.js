...
import Component from '@modals/m-activate-card.vue';
...
describe('m-activate-card.vue', () => {
	...
	it('has a name equal to m-activate-card', () => {
		expect(wp.vm.$options.name).toBe('m-activate-card');
	});
