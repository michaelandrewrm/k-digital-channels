...
import Component from '@modals/m-something-wrong';
...
describe('m-something-wrong.vue', () => {
	let wp;
	...
	it('has a name equal m-something-wrong', () => {
		expect(wp.vm.$options.name).toBe('m-something-wrong');
	});
