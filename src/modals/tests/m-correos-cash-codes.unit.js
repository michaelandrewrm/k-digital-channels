...
import Component from '@modals/m-correos-cash-codes';
...
describe('m-correos-cash-codes.vue', () => {
	let wp;
	let store;
	...
	it('has a name equal to m-correos-cash-codes', () => {
		expect(wp.vm.$options.name).toBe('m-correos-cash-codes');
	});
