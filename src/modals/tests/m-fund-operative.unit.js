...
import Component from '@modals/m-fund-operative.vue';
...
describe('m-fund-operative.vue', () => {
	...
	it('has a name equal to m-fund-operative', () => {
		expect(wp.vm.$options.name).toBe('m-fund-operative');
	});
