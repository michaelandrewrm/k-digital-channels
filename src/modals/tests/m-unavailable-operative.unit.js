...
import Component from '@modals/m-unavailable-operative.vue';
...
describe('m-unavailable-operative.vue', () => {
	let wp;
	let store;
	...
	it('has a name equal m-unavailable-operative', () => {
		expect(wp.vm.$options.name).toBe('m-unavailable-operative');
	});
