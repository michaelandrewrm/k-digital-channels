...
import Component from '@modals/m-deposit-info.vue';
...
describe('m-deposit-info.vue', () => {
	...
	it('has a name equal to m-deposit-info', () => {
		expect(wp.vm.$options.name).toBe('m-deposit-info');
	});
