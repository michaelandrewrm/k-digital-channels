...
import Component from '@modals/m-confirm-favorite-deletion.vue';
...
describe('m-confirm-favorite-deletion.vue', () => {
	let wp;
	...
	it('has a name equal to m-confirm-favorite-deletion', () => {
		expect(wp.vm.$options.name).toBe('m-confirm-favorite-deletion');
	});
